...
public class Timeline extends Weibo{
	...
	public StatusWapper getUserTimelineByUid(String uid, Paging page,
			Integer base_app, Integer feature,String since_id) throws WeiboException {
		return Status.constructWapperStatus(client.get(
						...
						new PostParameter[] {
								...
								new PostParameter("feature", feature.toString()),
								new PostParameter("since_id", since_id == null ? "0" : since_id)},
						page));
	}
	public StatusWapper getUserTimelineByName(String screen_name, Paging page,Integer base_app, Integer feature,String since_id) throws WeiboException {
		return Status.constructWapperStatus(client.get(
						WeiboConfig.getValue("baseURL")	+ "statuses/user_timeline.json",
						new PostParameter[] {
								new PostParameter("screen_name", screen_name),
