...
public interface MemberDAO{
	...
	List<MemberInfoCogBean> selectInfoListByPage(
	...
	int selectForContuine(MemberInfoBean memberInfoBean);

	int selectCountEntityCardByPage(MemberEntityCardBean memberEntityCardBean);

	List<MemberEntityCardBean> selectEntityCardByPage(
	...
	MemberEntityCardBean selectEntityCardByCardId(
			MemberEntityCardBean memberEntityCardBean);
