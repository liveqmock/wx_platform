...
public interface GuaguakaDAO {
	...
	int updateInfoForUsed(GuaguakaInfoBean guaguakaInfoBean);

	int updateInfoForContact(GuaguakaInfoBean guaguakaInfoBean);

	GuaguakaInfoBean selectOneInfo(GuaguakaBean guaguakaBean);

	int insertOneInfo(GuaguakaBean guaguakaBean);

	int selectCountOfWin(GuaguakaBean guaguakaBean);
	...
	int updateInfoForUsedForDazhuanpan(GuaguakaInfoBean guaguakaInfoBean);

	int updateInfoForContactForDazhuanpan(GuaguakaInfoBean guaguakaInfoBean);

	GuaguakaInfoBean selectOneInfoForDazhuanpan(GuaguakaBean guaguakaBean);

	int insertOneInfoForDazhuanpan(GuaguakaBean guaguakaBean);

	int selectCountOfWinForDazhuanpan(GuaguakaBean guaguakaBean);
