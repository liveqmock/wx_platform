					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="memberBean.keywords" value="会员卡">
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="memberBean.title" value="微信会员卡">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<div class="frm_input_box">
									...
									<p class="js_cover upload_preview" style="display: block;">
										<img src="<%=path%>/weixin/member/image/menber_card.jpg" id="upload_preview_img" style="margin-bottom: 10px;">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" name="memberBean.desc_service" >微信会员卡可以每日签到赚取积分,查看最新会员通知,特权以及积分兑换活动。</textarea>
							</div>
			...
			<tr>
				<td  style="width: 40%;">
							<div class="appmsg_edit_item">
								...
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_welcome"  style="width: 80%; height: 60px;" >会员尊享多种超值特权！</textarea>
				...
				<td style="width: 60%">
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									<input id="card_name" onkeyup="cardNameOnChange()"  style="width: 30%;" type=text class="frm_input " name="memberBean.card_name" value="微信封会员卡" ><span style="color: red;">*</span>
								...
								<span >
										<div class="meta_content">
												...
												<span> <input type="hidden" id="wx_upload_file"
														name="memberBean.card_logo" value="<%=path%>/weixin/member/image/html5.png"> <input
								...
								<span >
										<div class="meta_content">
												<img id="thumb_img_type"
													src="<%=path %>/weixin/member/image/card_1.png"
													style="max-width: 360px;max-height: 70px;">
												<span> <input type="hidden" id="wx_upload_file_type"
														name="memberBean.card_type_img" value="<%=path%>/weixin/member/image/card_1.png"> <input
							...
							<div class="appmsg_edit_item sel_type">
								...
								<span>
									...
									<input type="hidden" id="card_template_hidden" name="memberBean.card_template" value="6"/>
							...
							<div class="appmsg_edit_item sel_type">
								...
								<span  >
									<input style="width: 30%;"  type="text" id="cp1" name="memberBean.card_color_name" readonly="readonly" value="#a6a08b"/><span style="color: red;">*</span>
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span  >
									<input style="width: 30%;"  type="text" id="cp2" name="memberBean.card_color_number"  readonly="readonly" value="#847d64"/><span style="color: red;">*</span>
								</span>
							</div>					
				</td>
			</tr>
		...
		<div class="main_bd">
			...
			<div class="main_bd">
							<div class="appmsg_edit_item">
								...
								<span  >
									<input  style="width: 15%;" type="text" class="frm_input " name="memberBean.card_new_yue" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0"><span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									<input  style="width: 15%;" type="text" class="frm_input " name="memberBean.card_new_jifen" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0"><span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									<input  style="width: 15%;" type="text" class="frm_input " name="memberBean.card_integral" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0"><span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									<input  style="width: 15%;" type="text" class="frm_input " name="memberBean.card_contuine_integral" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0"><span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									<input  style="width: 15%;" type="text" class="frm_input " name="memberBean.card_perfect_info" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0"><span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item">
								...
								<span  >
									每消费<input  style="width: 10%;" type="text" class="frm_input " name="memberBean.card_rule_xiaofei" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0">元, 赠送
									<input  style="width: 10%;" type="text" class="frm_input " name="memberBean.card_rule_zengsong" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" value="0">积分<span style="color: red;">*</span>
							...
							<div class="appmsg_edit_item" id="card_entity_check" style="display: none;">
								...
								<span  >
									 ...
									 <input  id="card_issupport_check" type="hidden" name="memberBean.card_issupport_check"/>
			...
			<div class="main_bd">			
							<div class="appmsg_edit_item">
								...
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_explain"  style="width: 50%; height: 60px;" ></textarea>
							...
							<div class="appmsg_edit_item">
								...
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_yue"  style="width: 50%; height: 60px;" ></textarea>
							...
							<div class="appmsg_edit_item">
								...
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_jifen"  style="width: 50%; height: 60px;" ></textarea>
								<span class="help-block">填写后,用户可以在会员卡页面看到积分规则,可以用有吸引力的奖品来吸引用户每日签到来换取奖品。<br>例如可以在用户分享一些消息到朋友圈并截图后,赠送积分,再进行兑换。</span>
							</div>							

							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
									通知1标题:<input  style="width: 30%;" type=text class="frm_input " name="memberBean.card_notice1" >
								</label>
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_notice1_content"  style="width: 50%; height: 60px;"></textarea>
								<span class="help-block">填写后,用户可以在会员卡页面看到通知消息,可以再次编辑来修改通知。标题不超过30字，内容不超过500字。</span>
							</div>	
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
									通知2标题:<input  style="width: 30%;" type=text class="frm_input " name="memberBean.card_notice2" >
								</label>
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_notice2_content"  style="width: 50%; height: 60px;"></textarea>
							</div>	
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
									通知3标题:<input  style="width: 30%;" type=text class="frm_input " name="memberBean.card_notice3" >
								</label>
								<textarea class="js_desc frm_textarea textarea"  name="memberBean.card_notice3_content"  style="width: 50%; height: 60px;"></textarea>
							</div>																						
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
...
<script>
	$(document).ready(function(){
		...
		//图像
		$('.js_appmsg_thumb').attr('src','<%=path%>/weixin/member/image/menber_card.jpg');
		$('.js_appmsg_thumb').css('display','block');
		$('.frm_input_hidden').val('<%=path%>/weixin/member/image/menber_card.jpg');
		//摘要
	...
	function addSave(){
		...
		$.ajax({
			...
			type : 'POST',
			data : params,
			url : 'member!addSave.action', //请求的action路径
