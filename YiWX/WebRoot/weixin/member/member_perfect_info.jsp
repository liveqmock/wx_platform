...
<html >
	...
	%>
        ...
        <script src="<%=path%>/weixin/member/js/wei_webapp_v2_common.js?v=1.0.1"></script>
        <script src="<%=path%>/weixin/member/js/wei_webapp_v2.js?v=1.0.1"></script>
	...
	<body>
		...
		<form id="member">
		<input id="service_id"  type="hidden" value="<%=memberBean.getId()%>"/>
			...
			<div class="mod_input qb_mb10 qb_flex" id="divName">
                ...
                if(memberInfoBean.getCard_name()!=null){
                	%>
                	<input value="<%=memberInfoBean.getCard_name()%>" class="flex_box" placeholder="请输入姓名" id="inName" type="text" name="memberInfoBean.card_name"/>
                	<%
                }else{
                	%>
                	<input value="" class="flex_box" placeholder="请输入姓名" id="inName" type="text" name="memberInfoBean.card_name"/>
                	<%
                }
                %>
			</div>
			...
			<div class="mod_input qb_mb10">
				性　　别：<label  class="qb_mr10">
				 ...
				 <input id="card_sex" type="hidden" value="<%=memberInfoBean.getCard_sex()%>" name="memberInfoBean.card_sex">
			</div>
			                        			<!-- 生日 -->
			<div class="mod_input qb_mb10 qb_flex" >
                ...
                <input id="card_birthday" name="memberInfoBean.card_birthday" type="hidden" value="<%=memberInfoBean.getCard_birthday()%>">
			</div>
			...
			<div class="mod_input qb_mb10 qb_flex" id="divTel">
        	 ...
        	 <%
                if(memberInfoBean.getCard_tel()!=null){
                	%>
                	<input value="<%=memberInfoBean.getCard_tel()%>" name="memberInfoBean.card_tel" class="flex_box" placeholder="请输入手机号" id="inTel" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')"  />
                	<%
                }else{
                  	%>
                	<input value="" name="memberInfoBean.card_tel" class="flex_box" placeholder="请输入手机号" id="inTel" type="text" onkeyup="this.value=this.value.replace(/\D/g,'')"  onafterpaste="this.value=this.value.replace(/\D/g,'')" />
                	<%               	
                }
       		  %>				
			</div>
...
function submit_perfect_entity(){
	...
	$.ajax({
		...
		type : 'POST',
		data : params,
		url : 'memberwx!submit_perfect_entity.action', //请求的action路径
