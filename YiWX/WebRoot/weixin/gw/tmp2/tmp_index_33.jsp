...
#mainmenu li{
	...
	float: left;
	width: 33.3%;
	background:-webkit-gradient(linear, left top, right bottom, from(#6d6d6d), to(#353535));
}
#mainmenu li:nth-child(even){
	background:-webkit-gradient(linear, left top, right bottom, from(#91aecc), to(#3a659a));
}
#mainmenu li a{
	display: block;
	height: 100%;
...
<div id="mainmenu" class="fn-clear">
	...
	<div id="footer" style="background: rgba(0,0,0,0.3);">Copyright © 2012 - 2013 微信封<br/><a href="http://wwww.vxinfeng.com" target="_blank" class="page-url-link">此功能由“微信封”平台提供</a></div>
