...
#mainmenu li:nth-child(odd) .menu1{
	height: 130px;
	background-color: #d87570;
}
#mainmenu li:nth-child(odd) .menu1 .title{
	line-height: 30px;
	font-size: 1em;
	width: 95%;
	position: absolute;
...
#mainmenu li:nth-child(odd) .menu1 .summary{
	line-height: 20px;
	font-size: 0.7em;
	width: 95%;
	height: 40px;
...
#mainmenu li:nth-child(odd) .menu1 .icon{
	position: absolute;
	right: 3px;
	bottom: 3px;
...
#mainmenu li:nth-child(odd) .menu2{
	height: 70px;
	background-color: #6f9e98;
	margin-top: 3px;
}
#mainmenu li:nth-child(odd) .menu2 .title{
	line-height: 30px;
	font-size: 1em;
	width: 95%;
	position: absolute;
...
#mainmenu li:nth-child(odd) .menu2 .summary{
	display: none;
}
#mainmenu li:nth-child(odd) .menu2 .icon{
	position: absolute;
	left: 3px;
	bottom: 3px;
	height: 30px;
...
#mainmenu li:nth-child(even) .menu1{
	height: 70px;
	background-color: #b3cfc0;
}
#mainmenu li:nth-child(even) .menu1 .title{
	line-height: 30px;
	font-size: 1em;
	width: 95%;
	position: absolute;
...
#mainmenu li:nth-child(even) .menu1 .summary{
	display: none;
}
#mainmenu li:nth-child(even) .menu1 .icon{
	position: absolute;
	right: 3px;
	bottom: 3px;
	height: 30px;
}
#mainmenu li:nth-child(even) .menu2{
	height: 130px;
	background-color: #bc4040;
	margin-top: 3px;
}
#mainmenu li:nth-child(even) .menu2 .title{
	line-height: 30px;
	font-size: 1em;
	width: 95%;
	position: absolute;
...
#mainmenu li:nth-child(even) .menu2 .summary{
	line-height: 20px;
	font-size: 0.7em;
	width: 95%;
	height: 40px;
...
#mainmenu li:nth-child(even) .menu2 .icon{
	position: absolute;
	left: 3px;
	top: 6px;
	height: 30px;
...
<div id="mainmenu" class="fn-clear">
	...
	%>
	<%
		for(int i=0; i<mainActionEvents.size(); i++){
			ActionViewModel mainActionEvent = mainActionEvents.get(i);
	%>
		<li>
			
			<a class="menu1" href="<%=mainActionEvent.getLink() %>">
	...
	<%
			i++;
			if(i<mainActionEvents.size()){
				ActionViewModel mainActionEvent1 = mainActionEvents.get(i);
	%>		
			<a class="menu2" href="<%=mainActionEvent.getLink() %>">
				<i class="icon <%=mainActionEvent1.getIcon() %>"></i>
				<p class="title"><%=mainActionEvent1.getTitle() %></p>
				<!-- <p class="summary"><%=mainActionEvent1.getTitle() %></p> -->
			</a>
