...
<div class="page" style="padding-bottom:52px;">
	...
	#mainmenu li:nth-child(5n-4){
		background-color: #d47314;
		margin-right: 6px;
	}
	#mainmenu li:nth-child(5n-3){
		background-color: #5ab244;
	}
	#mainmenu li:nth-child(5n-2){
		background-color: #2075ae;
		width: 100%;
		height: 90px;
	}
	#mainmenu li:nth-child(5n-2) .icon{
		display: none;
	}
	#mainmenu li:nth-child(5n-2) .title{
		left: 206px;
		top: 32px;
		white-space: nowrap!important;
		width: 83px;
	}
	#mainmenu li:nth-child(5n-2) img{
		width: 187px;
		height: 100%;
		display: block;
	}
	#mainmenu li:nth-child(5n-1){
		background-color: #dd399a;
		margin-right: 6px;
	}
	#mainmenu li:nth-child(5n){
		background-color: #543da5;
	}
	</style>
