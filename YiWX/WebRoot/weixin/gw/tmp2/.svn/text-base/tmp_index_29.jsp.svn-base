...
<div id="page" style="padding-bottom:1px;">
<!--
	幻灯片管理
	-->
...
#mainmenu .secondmenu li{
	height: 180px;
	list-style: none;
	margin-bottom: 5px;
	position: relative;
}
#mainmenu .secondmenu li a{
	display: block;
	width: 100%;
	height: 100%;
}
#mainmenu .secondmenu li .title{
	position: absolute;
	width: 100%;
	height: 35px;
	background: rgba(33,107,146,0.6);
	color: white;
	top: 0;
	line-height: 35px;
	text-align: center;
