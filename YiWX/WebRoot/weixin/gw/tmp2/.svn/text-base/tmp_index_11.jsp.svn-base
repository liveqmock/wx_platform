...
<div class="page" style="padding-bottom:2px;padding-top:52px;">
	...
	#mainmenu li.menu-2{
		background-color: #fe502b;
		height: 75px;
	}
	#mainmenu li.menu-2 .icon,#mainmenu li.menu-7 .icon{
		margin-top: 10px;
	}
	#mainmenu li.menu-2 img,#mainmenu li.menu-7 img{
		margin-top: 10px;
	}
	#mainmenu li.menu-3{
	...
	.page-url-link:link,.page-url-link:visited{
	    color: #FFF;
	}
	</style>
	<div id="mainmenu" class="fn-clear">
		...
		%>
		<div class="tel-cont bgcolor">
			<a href="tel:<%=websiteViewModel.getPhoneNumber() %>">
			<i class="icon icon-phone"></i>
			<p class="title"><%=websiteViewModel.getPhoneNumber() %></p></a>
		 </div>
		<%
			}
		%>
