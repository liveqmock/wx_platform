...
.main_icon{width:100px;height:100px;}
</style>
  <script type="text/javascript">
...
<div class="cate_list">
        ...
        <div class="cate_lo add_qq_more">
            <a href="javascript:;">
                ...
                <p style="text-align:right;"><img src="<%=path%>/weixin/gw/images/9_2.png" class="m_pic"></p>
            </a>
        </div>	
        <div class="cate_lp add_qq_more">
            <a href="javascript:;">
                <p style="text-align:center;"><img src="<%=path%>/weixin/gw/images/7_2.png" class="m_pic"></p>
                <p class="m_text">关于我们</p>
            </a>
        </div>
        <div class="cate_lp add_qq_more">
            <a href="javascript:;">
                <p style="text-align:center;"><img src="<%=path%>/weixin/gw/images/8_3.png" class="m_pic"></p>
                <p class="m_text">购物导视</p>
            </a>
        </div>
        <div class="cate_lp add_qq_more">
            <a href="javascript:;">
                <p style="text-align:center;"><img src="<%=path%>/weixin/gw/images/7_7.png" class="m_pic"></p>
                <p class="m_text">新闻动态</p>
            </a>
        </div>	
        <div class="cate_lp add_qq_more">
            <a href="javascript:;">
                <p style="text-align:center;"><img src="<%=path%>/weixin/gw/images/10_7.png" class="m_pic"></p>
                <p class="m_text">新闻动态</p>
            </a>
        </div>
        <div class="cate_lol add_qq_more">
            <a href="javascript:;">
                <p style="text-align:right;"><img src="<%=path%>/weixin/gw/images/001.png" class="m_pic"></p>
            </a>
        </div>
        <div class="cate_lor add_qq_more">
            <a href="javascript:;">
                <p style="text-align:right;"><img src="<%=path%>/weixin/gw/images/002.png" class="m_pic"></p>
            </a>
        </div>
         -->
        <%
		...
		%>
        <div class="cate_lp add_qq_more">
            <a href="<%=mainActionEvent.getLink() %>" style="float:none;">							
                <p style="text-align:center;">
                <!-- <img src="<%=mainActionEvent.getIcon() %>" class="m_pic"> -->
                <i class="icon <%=mainActionEvent.getIcon() %>" style="float:none;width:40px;height:40px;margin:0px;"></i>
                </p>
                <p class="m_text"><%=mainActionEvent.getTitle() %></p>
            </a>
        </div>	
        <%} %>
