	...
	<form class="form-horizontal" style="display: block;" id="tform">
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="title" name="researchViewModel.title" class="span4">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" id="option1" name="researchViewModel.answer_a">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" id="option2" name="researchViewModel.answer_b">
					<span class="maroon">*</span><span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option3" name="researchViewModel.answer_c">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option4" name="researchViewModel.answer_d">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option5" name="researchViewModel.answer_e">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option6" name="researchViewModel.answer_f">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option7" name="researchViewModel.answer_g">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option8" name="researchViewModel.answer_h">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option9" name="researchViewModel.answer_i">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" class="option" readonly="readonly" id="option10" name="researchViewModel.answer_j">
					<span class="help-inline">长度不超过16个字符</span>
				</div>
			</div>
			<div class="control-group">
...
$(function(){
    ...
    function addSave() {
		...
		$.ajax({
			...
			type : 'POST',
			data : params,
			url : 'research!addNewResearch.action?basicid=<%=request.getAttribute("basicid").toString()%>', //请求的action路径
