						...
						<div id="js_appmsg_preview" class="appmsg_content">
							<div id="appmsgItem1" data-fileid="" data-id="1"
								...
								<div class="appmsg_thumb_wrp">
									<img class="js_appmsg_thumb appmsg_thumb" src="<%=path%>/weixin/message/images/cover.jpg">
					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="messagebasicViewModel.keywords" required="required" value="微留言">
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="messagebasicViewModel.title" required="required" value="微留言">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<div class="frm_input_box">
									...
									<p class="js_cover upload_preview" style="display: block;">
										<img src="<%=path%>/weixin/message/images/cover.jpg" id="upload_preview_img" style="margin-bottom: 10px;">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" name="messagebasicViewModel.descs" required="required">点击进行留言</textarea>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	$(document).ready(function(){
		...
		//图像
		$('.js_appmsg_thumb').attr('src','<%=path%>/weixin/message/images/cover.jpg');
		$('.js_appmsg_thumb').css('display','block');
		$('.frm_input_hidden').val('<%=path%>/weixin/message/images/cover.jpg');
		//摘要
    ...
    function addSave() {
		...
		if(!cansv){
			...
			$.ajax({
				...
				type : 'POST',
				data : params,
				url : 'messagebasic!addNewMessagebasic.action', //请求的action路径
