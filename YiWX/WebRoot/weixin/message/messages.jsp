...
<title><%=messagebasicBean.getTitle() %></title>
				...
				<div class="history-date">
					<ul>
						...
						<form id="message1" role="form">
							<input type="hidden" name="messagebasicBean.id" value="<%=messagebasicBean.getId() %>">
							<dl>
								...
								<dt>
									<input style="margin-top: 10px" name="messageViewModel.tel" type="text" class="px" 
										value="" placeholder="请输入您的联系电话  选填">
								</dt>								
								<dt>
						...
						<form id="message2" role="form">
							...
							<dl>
								...
								<dt>
									<input name="messageViewModel.tel" type="text" class="px" 
										value="" placeholder="请输入您的联系电话  选填">
								</dt>
								<dt>
									<textarea name="messageViewModel.text" class="pxtextarea" style="height: 60px;"
