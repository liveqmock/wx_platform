					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="photobasicViewModel.keywords" required="required" value="微相册">
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="photobasicViewModel.title" required="required" value="微相册">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" name="photobasicViewModel.descs" required="required">点击访问我的微相册</textarea>
							</div>
						</div>
					</div>
				</div>
    ...
    function addSave() {
		...
		if(!cansv){
			...
			$.ajax({
				...
				type : 'POST',
				data : params,
				url : 'photobasic!addNewPhotobasic.action', //请求的action路径
