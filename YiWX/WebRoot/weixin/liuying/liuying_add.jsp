					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="liuyingBean.keywords" value="留影墙">
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="liuyingBean.title" value="留影墙">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<div class="frm_input_box">
									...
									<p class="js_cover upload_preview" style="display: block;">
										<img src="<%=path%>/weixin/liuying/img/liuyingqiang.jpg" id="upload_preview_img" style="margin-bottom: 10px;">
										<input  type="hidden" class="frm_input js_title frm_input_hidden" name="liuyingBean.img">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" name="liuyingBean.desc_service" >让这一刻定格!</textarea>
							</div>
...
<script>
	$(document).ready(function(){
		...
		//图像
		$('.js_appmsg_thumb').attr('src','<%=path%>/weixin/liuying/img/liuyingqiang.jpg');
		$('.js_appmsg_thumb').css('display','block');
		$('.frm_input_hidden').val('<%=path%>/weixin/liuying/img/liuyingqiang.jpg');
		//摘要
	...
	function addSave(){
		...
		$.ajax({
			...
			type : 'POST',
			data : params,
			url : 'liuying!addSave.action', //请求的action路径
