					...
					<h3>
						...
						<div class="main_bd">
							<div class="appmsg_edit_item">
								...
								<span >
									<input   style="width: 30%;" type="text" class="frm_input " name="lbsBean.title" >
							...
							<div class="appmsg_edit_item">
								...
								<span >
									<input   style="width: 30%;" type="text" class="frm_input " name="lbsBean.tel" >
							...
							<div class="appmsg_edit_item">
								...
								<span >
									<input  id="searchlocal" style="width: 30%;" type="text" class="frm_input " name="lbsBean.address" >
							...
							<div class="appmsg_edit_item">
								...
								<span >
									 <input type="text" id="lngMap" name="lbsBean.lng" readonly="readonly"/>&<input type="text" id="latMap" name="lbsBean.lat" readonly="readonly"/> 
							...
							<div class="appmsg_edit_item">
								...
								<textarea class="js_desc frm_textarea textarea"  name="lbsBean.desc_service"  style="width: 50%; height: 60px;" ></textarea>
...
<script>
	...
	function addSave(){
		...
		$.ajax({
			...
			type : 'POST',
			data : params,
			url : 'lbs!addSave.action', //请求的action路径
