							...
							<div class="inner_main">
								<div class="bd">
									<div class="sub_title_bar no_extra">
										<h3>
											<input name="messageViewModel.sender" type="text" placeholder="请输入昵称" style="margin-left:5px;margin-top: 3px"/>
											<input name="messageViewModel.text" type="text" placeholder="请输入内容" style="margin-left:5px;margin-top: 3px"/>																						
											<a onclick="querySn()" >
