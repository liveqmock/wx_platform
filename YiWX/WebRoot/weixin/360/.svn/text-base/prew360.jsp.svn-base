...
<html>
	...
	<body>
		...
		<div id="info"><a href="http://www.vxinfeng.com" target="_blank">微信封(www.vxinfeng.com)360全景</a>.</div>
		<script>
			...
			function init() {
				...
				var sides = [
					{
						url: '<%=path %>/weixin/360/images/posx.jpg',
						position: [ -512, 0, 0 ],
						rotation: [ 0, Math.PI / 2, 0 ]
					},
					{
						url: '<%=path %>/weixin/360/images/negx.jpg',
						position: [ 512, 0, 0 ],
						rotation: [ 0, -Math.PI / 2, 0 ]
					},
					{
						url: '<%=path %>/weixin/360/images/posy.jpg',
						position: [ 0,  512, 0 ],
						rotation: [ Math.PI / 2, 0, Math.PI ]
					},
					{
						url: '<%=path %>/weixin/360/images/negy.jpg',
						position: [ 0, -512, 0 ],
						rotation: [ - Math.PI / 2, 0, Math.PI ]
					},
					{
						url: '<%=path %>/weixin/360/images/posz.jpg',
						position: [ 0, 0,  512 ],
						rotation: [ 0, Math.PI, 0 ]
					},
					{
						url: '<%=path %>/weixin/360/images/negz.jpg',
						position: [ 0, 0, -512 ],
						rotation: [ 0, 0, 0 ]
					}
				];
