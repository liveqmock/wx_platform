		...
		<div class="col_main">
							...
							<div id="appmsgItem1" data-fileid="" data-id="1"
								...
								<h4 class="appmsg_title">
									<a onclick="return false;" href="javascript:void(0);"
										target="_blank"><%=quanjingBean.getTitle() %></a>
								</h4>
								<div class="appmsg_info">
									<em class="appmsg_date"><%=quanjingBean.getTime() %></em>
								</div>
								<div class="appmsg_thumb_wrp">
									<img class="js_appmsg_thumb appmsg_thumb" src="<%=quanjingBean.getImg()%>">
					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="quanjingViewModel.keywords" required="required" value="<%=quanjingBean.getKeywords() %>">
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="quanjingViewModel.title" required="required" value="<%=quanjingBean.getTitle() %>">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<div class="frm_input_box">
									...
									<p class="js_cover upload_preview" style="display: block;">
										<img src="<%=quanjingBean.getImg() %>" id="upload_preview_img" style="margin-bottom: 10px;">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" required="required" name="quanjingViewModel.text"><%=quanjingBean.getText() %></textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="box-content">
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl1() %>" id="prew_img_1" style="max-height:100px;" />							
				...
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl2() %>" id="prew_img_2" style="max-height:100px;" />								
						<span class="help-inline">
				...
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl3() %>" id="prew_img_3" style="max-height:100px;" />								
						<span class="help-inline">
				...
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl4() %>" id="prew_img_4" style="max-height:100px;" />								
						<span class="help-inline">
				...
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl5() %>" id="prew_img_5" style="max-height:100px;" />									
						<span class="help-inline">
				...
				<div class="control-group">
					...
					<div class="controls">
					<img class="thumb_img" src="<%=quanjingBean.getUrl6() %>" id="prew_img_6" style="max-height:100px;" />									
						<span class="help-inline">
...
<script>
	...
	function addSave() {
		...
		if(!cansv){
			...
			$.ajax({
				...
				type : 'POST',
				data : params,
				url : 'quanjing!updateQuanJing.action', //请求的action路径
	...
	$(document).ready(function(){
		...
		//图像
		$('.js_appmsg_thumb').attr('src','<%=quanjingBean.getImg()%>');
		$('.js_appmsg_thumb').css('display','block');
		$('.frm_input_hidden').val('<%=quanjingBean.getImg()%>');
		//摘要
