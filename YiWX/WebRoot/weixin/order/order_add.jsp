		...
		<div class="col_main">
						...
						<div id="js_appmsg_preview" class="appmsg_content">
							<div id="appmsgItem1" data-fileid="" data-id="1"
								...
								<div class="appmsg_thumb_wrp">
									<img class="js_appmsg_thumb appmsg_thumb" src="<%=path%>/weixin/order/image/yy_pic.jpg">
					...
					<div class="appmsg_editor" style="margin-top: 0px;">
						<div class="inner">
							<div class="appmsg_edit_item">
								...
								<span >
									<input type="text" class="frm_input" name="orderBean.keywords"  required="required" value="微预约" >
								</span>
							</div>
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<span >
									<input type="text" class="frm_input js_title" name="orderBean.title"  required="required" value="在线预约">
								</span>
							</div>							
							<div class="appmsg_edit_item">
								<label for="" class="frm_label">
								...
								<div class="frm_input_box">
									...
									<p class="js_cover upload_preview" style="display: block;">
										<img src="<%=path%>/weixin/order/image/yy_pic.jpg" id="upload_preview_img" style="margin-bottom: 10px;">
							...
							<div class="js_desc_area dn appmsg_edit_item">
								...
								<textarea style="height: 45px" maxlength="120" class="js_desc frm_textarea textarea" name="orderBean.descs" required="required">请点击进入在线预约页面!</textarea>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="main_bd">
				<div class="appmsg_edit_item">
					...
					<span >
						<input id="searchlocal" style="width: 30%;" type="text" class="frm_input " name="orderBean.place"  required="required">
				...
				<div class="appmsg_edit_item">
						...
						<span >
							 <input type="text" id="lngMap" name="orderBean.lng" readonly="readonly" required="required"/>&<input type="text" id="latMap" name="orderBean.lat" readonly="readonly" required="required"/> 
				...
				<div class="appmsg_edit_item">
								...
								<span >
									<input  style="width: 30%;" type="text" class="frm_input " name="orderBean.tel"  required="required">
							...
							<div class="appmsg_edit_item">
								<div class="control-group">
									...
									<input type="hidden" value ="" name="orderBean.conditions" class="bookingset"/>
                                    <div class="controls">
                                        <table class="table table-bordered table-hover dataTable" id="bookingtb" style="table-layout: fixed;">
											...
											<tr class="bookingtr" issys="0">
												<td class="booking_type">
													...
													<option value="text" data-name="电话号码" data-holder="请输入您的电话" selected="selected">单行文字</option>
												...
												<td class="booking_name">
												    <input type="text" class="wizard-ignore" required="required" value="联系人" >
												</td>
												<td class="booking_holder">
												    <input type="text" class="wizard-ignore" value="请输入您的名字" >
												</td>
											...
											<td class="booking_name">
											    <input type="text" class="wizard-ignore" required="required" value="联系电话">
											</td>
											<td class="booking_holder">
											    <input type="text" class="wizard-ignore" value="请输入您的电话">
											</td>
											<td><p><a href="javascript:;" class="yydelahref" onclick="dodelit(this)">删除</a>&nbsp;<a href="javascript:;" onclick="doaddit(this)">添加</a></p></td>
											</tr>
											...
											<td class="booking_type">
												...
												<option value="textarea" data-name="反馈意见" data-holder="请输入您的意见">多行文字</option>
												<option value="date" data-name="预定日期" data-holder="请选择">日期选择</option>
												<option value="datetime" data-name="入住时间" data-holder="请选择"  selected="selected">日期时间选择</option>
												<option value="select" data-name="入住人数" data-holder="1|2|3|4|5|6|7|8">自定义下拉选择</option>
												</select>
												日期选择
											</td>
											<td class="booking_name">
											    <input type="text" class="wizard-ignore" required="required" value="预约日期" >
											</td>
											<td class="booking_holder">
											    <input type="text" class="wizard-ignore" value="请选择预约日期" placeholder="">
											</td>
											<td><p><a href="javascript:;" class="yydelahref" onclick="dodelit(this)">删除</a>&nbsp;<a href="javascript:;" onclick="doaddit(this)">添加</a></p></td>
											</tr>
											<tr class="bookingtr" issys="0">
												<td class="booking_type">
													<select style="display: none;">
													<option value="text" data-name="电话号码" data-holder="请输入您的电话">单行文字</option>
													<option value="textarea" data-name="反馈意见" data-holder="请输入您的意见"  selected="selected">多行文字</option>
													<option value="date" data-name="预定日期" data-holder="请选择">日期选择</option>
													<option value="datetime" data-name="入住时间" data-holder="请选择">日期时间选择</option>
													<option value="select" data-name="入住人数" data-holder="1|2|3|4|5|6|7|8">自定义下拉选择</option>
													</select>
												...
												<td class="booking_name">
												    <input type="text" class="wizard-ignore" required="required" value="备注" >
												</td>
												<td class="booking_holder">
												    <input type="text" class="wizard-ignore" value="如有特殊需求请留言" >
												</td>
												<td><p><a href="javascript:;" class="yydelahref" onclick="dodelit(this)">删除</a>&nbsp;<a href="javascript:;" onclick="doaddit(this)">添加</a></p></td>
											</tr>											
											<tr class="bookingtr" issys="0">
											...
											<td class="booking_name">
											    <input type="text" class="wizard-ignore" required="required" value="自定义字段" >
											</td>
											<td class="booking_holder">
											    <input type="text" class="wizard-ignore" value="请输入">
											</td>
											<td><p><a href="javascript:;" class="yydelahref" onclick="dodelit(this)">删除</a>&nbsp;<a href="javascript:;" onclick="doaddit(this)">添加</a></p></td>
											</tr>
											...
											<tr class="bookingtr" issys="0">
												...
												<option value="date" data-name="预定日期" data-holder="请选择">日期选择</option>
												<option value="datetime" data-name="入住时间" data-holder="请选择">日期时间选择</option>
												<option value="select" data-name="入住人数" data-holder="1|2|3|4|5|6|7|8"  selected="selected">自定义下拉选择</option>
												</select>
												自定义下拉选择
											</td>
											<td class="booking_name">
											    <input type="text" class="wizard-ignore" required="required" value="自定义下拉框">
											</td>
											<td class="booking_holder">
											    <input type="text" class="wizard-ignore" value="选择1|选择2|选择3" >
											</td>
											<td><p><a href="javascript:;" class="yydelahref" onclick="dodelit(this)">删除</a>&nbsp;<a href="javascript:;" onclick="doaddit(this)">添加</a></p></td>
											</tr>
...
<script>
	...
	$(document).ready(function(){
		...
		//图像
		$('.js_appmsg_thumb').attr('src','<%=path%>/weixin/order/image/yy_pic.jpg');
		$('.js_appmsg_thumb').css('display','block');
		$('.frm_input_hidden').val('<%=path%>/weixin/order/image/yy_pic.jpg');
		//摘要
