...
<body>
	...
	<div class="g" id="crumbs">
		<a href="<%=path%>" class="r" id="goback"><返回首页></a><span><a href="<%=path%>">首页</a><span> > </span><a href="<%=path%>/gongneng.jsp">功能</a> > <a href="#">行业版</a> > </span>首次关注	</div>
	<div class="g">
		<div id="mdCnt">
			<p><img src="<%=path %>/gongneng/pic/20140120020320228.jpg" /><br /></p>		</div>
	</div>
