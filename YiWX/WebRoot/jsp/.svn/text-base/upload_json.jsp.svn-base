...
//String savePath = pageContext.getServletContext().getRealPath("/") + "attached/" + appId + "/";
//文件保存目录URL
String saveUrl = request.getContextPath() + "/attached/";
//String saveUrl = request.getContextPath() + "/attached/" + appId + "/";
...
//add by gaozhixiang
//String ymd = appId + "/" +sdf.format(new Date());
String ymd = uid ;
//end gaozhixiang
savePath += ymd + "/";
saveUrl += ymd + "/";
