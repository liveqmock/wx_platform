...
var b = u.itemRender, w = a.declare({
select: function() {
...
$("." + t.info.selector).html('<div id="%s"></div>'.sprintf(i)), b[e] && b[e]("#" + i, n);
}
}), !1;
},
fillData: function(e) {
var t = this.msgSender, n = this.type, r = "msgSender_media_%s_%s".sprintf(t.gid, n);
$("." + this.info.selector).html('<div id="%s"></div>'.sprintf(r)), t.select(this.index), this.msgSender.type = n, b[n] && b[n]("#" + r, e);
},
clear: function() {
var e = this.type;
...
init: function(e, t) {
var n = this, r = 0;
e = $(e).show(), n.gid = d++, n.opt = $.extend(!0, {}, x, t);
var i = m, s = t && t.acl || {};
i = g(i, s), n.infos = y(i), n.op = {
"1": new E(n),
"2": new S(n, 2),
"3": new S(n, 3),
"4": new S(n, 4),
...
});define("message/send.js", [ "common/qq/emoji.js", "common/wx/richEditor/msgSender.js", "message/message_cgi.js", "message/renderList.js", "common/wx/verifycode.js" ], function(e, t, n) {
try {
var r = +(new Date);
"use strict", e("common/qq/emoji.js");
var i = wx.cgiData, s = i.tofakeid, o = i.to_nick_name, u = i.msg_items.msg_item, a = e("common/wx/richEditor/msgSender.js"), f = e("message/message_cgi.js");
...
var i, o, h, p = e("message/renderList.js"), d = function() {
f.getNewMsg(s, i, o, h, function(e) {
...
acl: wx.acl.msg_acl
}), m = null, g = $("#verifycode"), y = e("common/wx/verifycode.js");
$("#js_submit").click(function() {
var e = v.getData();
if (e.error) return;
var t = e.data;
t.tofakeid = s, t.fileid = t.file_id, t.appmsgid = t.app_id;
...
var n = $(this).btn(!1);
f.sendMsg(t, function(e) {
n.btn(!0), g.html("").hide(), m = null, v.clear(), c = 3 * l, setTimeout(d, c);
}, function(e) {
g.html("").hide(), n.btn(!0), e.base_resp && e.base_resp.ret == -8 && (m = g.html("").show().verifycode().data("verifycode"), m.focus());
});
});
})(i);
} catch (h) {
