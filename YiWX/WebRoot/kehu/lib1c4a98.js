...
d.promise(x).complete = v.add, x.callback = x.success = x.done, x.error = x.fail, c.url = ((e || c.url || gn) + "").replace(wn, "").replace(Nn, mn[1] + "//"), c.type = n.method || n.type || c.method || c.type, c.dataTypes = b.trim(c.dataType || "*").toLowerCase().match(E) || [ "" ], c.crossDomain == null && (r = Cn.exec(c.url.toLowerCase()), c.crossDomain = !(!r || r[1] === mn[1] && r[2] === mn[2] && (r[3] || (r[1] === "http:" ? 80 : 443)) == (mn[3] || (mn[1] === "http:" ? 80 : 443)))), c.data && c.processData && typeof c.data != "string" && (c.data = b.param(c.data, c.traditional)), Dn(Ln, c, n, x);
if (w === 2) return x;
...
}), e.jQuery = e.$ = b, typeof define == "function" && define.amd && define.amd.jQuery && define("common/lib/jquery.js", [], function(e, t, n) {
try {
var r = +(new Date);
return b;
} catch (i) {
...
})(window);;var template = function(e, t) {
...
})(template, this), typeof define == "function" ? define("common/lib/template.js", [], function(e, t, n) {
try {
var r = +(new Date);
n.exports = template;
} catch (i) {
wx.jslog({
src: "common/lib/template.js"
}, i);
}
