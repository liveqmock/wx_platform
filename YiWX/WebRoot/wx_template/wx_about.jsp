...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="<%=path%>/css/index.css" media="all" />
		<link rel="stylesheet" type="text/css"
						...
						<div class="box">
							...
							<div class="box-content">
								<div class="bs-docs-example">
									...
									<p>
										微信封是一个专门针对微信公众账号提供营销推广服务的第三方平台。主要功能是针对微信商家公众号提供与众不同的、有针对性的营销推广服务。通过微信封平台，用户可以轻松管理自己的微信各类信息，对微信公众账号进行维护、开展智能机器人、在线发优惠劵、抽奖、刮奖、派发会员卡、打造微官网、开启微团购等多种活动，对微信营销实现有效监控，极大扩展潜在客户群和实现企业的运营目标。微信封平台很好的弥补了微信公众平台本身功能不足、针对性不强、交互不便利的问题，为商家公众账号提供更为贴心的、且是核心需求的功能和服务。在线优惠劵、转盘抽奖、微信会员卡等推广服务更是让微信成为商家推广的利器。智能客服的可调教功能让用户真正从微信繁琐的日常客服工作中解脱出来，真正成为商家便利的新营销渠道。
									</p>
									<br>
									<h4 class="text-success">
										为什么选择微信封（vxinfeng）？
									...
									<p>
										哪里有人哪里就有商业，哪里就有盈利空间。据第三方统计70%的手机用户开通了个人微信，其年龄涵盖了小学生至老年人，各年龄阶层的人群。截止目前腾讯已拥有4亿的微信用户，7亿的qq用户。
									</p>
									<p>
										消费者才是企业追逐的目标，人的数量决定了财富的数量。
									</p>
									<br>
									<h6 class="text-success">
										O 微信营销的趋势与巨大利润空间
									...
									<table id="listTable"
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<strong class="text-success">微营销成为企业营销新渠道</strong>
													微信封为企业微信营销提供智能的服务平台和完整的解决方案
												</td>
											</tr>
											<tr>
												<td>
												...
												<td>
													<strong class="text-success">微信封——理论加实践的产物</strong>
													微信封平台根据市场行业需求，制定行业标准解决方案。
												</td>
											</tr>
											<tr>
												<td>
												...
												<td>
													<strong class="text-success">微信封平台解决企业开发烦恼</strong>
											...
											<tr>
												...
												<td>
													<strong class="text-success">行业需求，定制开发</strong>
											...
											<tr>
												...
												<td>
													<strong class="text-success">微信封——微信智能服务平台</strong>
											...
											<tr>
												...
												<td>
													<strong class="text-success">微信封——功能强大，满足个性需求</strong>
									...
									<p>
										根据企业发展的现状、未来的发展趋势，以及遇到的竞争对手情况，微信封帮助企业分析发展中将会遇到哪些问题？以及如何把握行业的最新动态？如何采取最佳的解决策略？微信封将为您提供一套完整的、贴心的解决方案。
									</p>
									<p>
										<strong>解决方案</strong>
									</p>
									<p>
										微信封为企业提供行业报告、行业动态、行业案例，并与战略合作伙伴在全国重点行业城市，联手打造行业信息化战略目标，为参与系列活动的行业企业提供高质量的微信营销知识培训。“百度商情”、“行业企业身份认证”等企业特权服务也将陆续为战略合作伙伴的会员企业服务。
									</p>
									<h6 class="text-success">
										O 资深客服服务
									</h6>
									<p>
										1、 1年以上客服经验，通过微信封服务认证考试。
									</p>
									<p>
										2、 跟踪用户需求，提供专业优化方案。
									</p>
