...
<link rel="stylesheet" type="text/css" href="<%=path %>/css/indexbanner.css" >
<script type="text/javascript" src="<%=path %>/js/jquery.js"></script>
<script type="text/javascript" src="<%=path %>/js/lang.js"></script>
...
.menubg{
/*background: url(./themes/Home/iMicro/common/images/img/current-.gif) repeat-y 170px top;*/
overflow-x: hidden;
overflow-y: auto;
...
/*background:#fff url(./themes/Home/iMicro/common/images/img/current.gif) no-repeat right center;*/
}
.menu0 div span{
 background: url(./themes/Home/iMicro/common/images/img/icon_new.gif) no-repeat scroll 0 0 transparent;
    border: 0 none;
    display: block;
    height: 11px;
    position: absolute;
...
<div class="qtcontent">
        <div class="intro">
            <div class="normalTitle"><h2>爱微功能简介</h2></div>
            <div class="normalContent">
<div class="section">
                    <div id="table">
                    <div class="menubg">
                        <div class="menu0" id="menu0">
                            <div class="" onclick="setTab(0,0)">1.天气查询(语音)</div>
...
<p>备注：如果后台开启语音播报天气功能，回复就是语音播报，更有意思！</p>
                                ...
                                <img alt="" src="images/gn001.jpg">
<img alt="" src="images/gn001-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>2.快递查询</h3>
                            ...
                            <div style="display: none;">
                                ...
                                <img alt="" src="images/gn006.jpg">
                                <img alt="" src="images/gn006-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>7.健康指数查询</h3>
...
<p>学习世界语言的必备武器！更有意思！</p>
                                ...
                                <img alt="" src="images/gn008.jpg">
                                <img alt="" src="images/gn008-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>9.百度百科</h3>
                                ...
                                <img alt="" src="images/gn009.jpg">
                                <img alt="" src="images/gn009-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>10.百度问答</h3>
                                ...
                                <img alt="" src="images/gn010.jpg">
                                <img alt="" src="images/gn010-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>11.人品计算</h3>
                            ...
                            <div style="display: none;">
                                ...
                                <img alt="" src="images/gn012.jpg">
                                <img alt="" src="images/gn012-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>13.糗事</h3>
                                ...
                                <img alt="" src="images/gn013.jpg">
                                <img alt="" src="images/gn013-2.jpg">
                            </div>
                            <div style="display: none;">
                                <span class="marginb">
                                <h3>14.谜语</h3>
...
<p>还有关联的图文展示，推荐阅读。</p>
                                ...
                                <img alt="" src="images/gn020.jpg" style="vertical-align: top">
<img alt="" src="images/gn020-2.jpg">
                            </div>
                    		<div style="display: none;">
                                <span class="marginb">
                                <h3>21.藏头藏尾诗</h3>
...
<p>还可以输入：陈奕迅的歌或者播放浮夸</p>
                                ...
                                <img alt="" src="images/gn024.jpg">
<img alt="" src="images/gn024-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>25.网络电影搜索</h3>
...
<p>例如：彩票双色球</p>
                                ...
                                <img alt="" src="images/gn028.jpg">
<img alt="" src="images/gn028-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
...
<div style="display: none;">
                                ...
                                <img alt="" src="images/gn031.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>32.淘宝客模块</h3>
                                <p>开启此功能，输入：淘宝内衣或者淘宝鞋子，可以查询淘宝的商品。</p>
<p>系统还有专门的淘宝客功能，适合做手机淘宝客的人使用，粉丝购买后可以得到佣金，手机支付以后是个趋势，抓住先机，以后佣金倍增。</p>
                                </span>
                                <img alt="" src="images/gn032.jpg">
<img alt="" src="images/gn032-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>33.周边商铺</h3>
                                ...
                                <img alt="" src="images/gn033.jpg">
<img alt="" src="images/gn033-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>34.刮刮卡刮奖活动</h3>
...
<p style=" color:#F00">备注：目前安卓4.1的系统跟微信4.5有些兼容性问题，导致刮刮卡不能刮，还是可以抽奖，就是少了刮的体验，其他都正常，如果介意的话，请等待微信升级解决此问题后再使用，或者换其他活动。</p>
                                ...
                                <img alt="" src="images/gn034.jpg">
<img alt="" src="images/gn034-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>35.幸运大转盘活动</h3>
...
<p>输入"大转盘"体验此互动活动</p>
                                ...
                                <img alt="" src="images/gn035.jpg">
<img alt="" src="images/gn035-2.jpg">
                            </div>
<div style="">
                                <span class="marginb">
                                <h3>36.优惠券活动</h3>
...
<p>输入"优惠券"体验此互动活动</p>
                                ...
                                <img alt="" src="images/gn036.jpg">
<img alt="" src="images/gn036-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>37.周边生活地图版</h3>
...
<p>例如 附近酒吧,附近学校,附近工商银行,附近医院,附近小吃,附近美食,附近酒吧,附近咖啡厅,附近公交站,附近加油站.......</p>
                                ...
                                <img alt="" src="images/gn037.jpg">
<img alt="" src="images/gn037-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>38.步行导航</h3>
...
<p>步行厦大医院到厦大西村 或 厦大医院到厦大西村怎么走</p>
                                ...
                                <img alt="" src="images/gn038.jpg">
<img alt="" src="images/gn038-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>39.驾车导航</h3>
...
<p>备注：进入地图还可以进行起点拖动使用</p>
                                ...
                                <img alt="" src="images/gn039.jpg">
<img alt="" src="images/gn039-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>40.路况查询</h3>
...
<p>红色表示拥堵，黄色表示有点堵，绿色表示道路很畅通。请点击放大看详情。</p>
                                ...
                                <img alt="" src="images/gn040.jpg">
<img alt="" src="images/gn040-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
...
<p>例如：附近便利店 附近医院 附近美食 附近小吃 等等</p>
                                ...
                                <img alt="" src="images/gn041.jpg">
<img alt="" src="images/gn041-2.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>42.公交换成地图版</h3>
...
<p>例如：公交龙山桥到SM 或者 厦大西村到中山路怎么坐车</p>
                                ...
                                <img alt="" src="images/gn042.jpg">
<img alt="" src="images/gn042-2.jpg">
<img alt="" src="images/gn042-3.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>43.查药价</h3>
...
<p>例如：药价 Z11021209 或者 药价 桑菊感冒颗粒</p>
                                ...
                                <img alt="" src="images/gn043.jpg">
<img alt="" src="images/gn043-2.jpg">
                            </div>
<div style="display:none;">
                                <span class="marginb">
                                <h3>44.投票活动</h3>
                                <p>开启此开关,可以发起文本投票和图片投票两种形式，可单选和多选。</p>
<p>范例：给微信号输入“投票”或者“图片投票”体验一下投票活动。</p>
                                </span>
                                <img alt="" src="images/gn044.jpg">
                            </div>
<div style="display: none;">
                                <span class="marginb">
                                <h3>45.自定义LBS数据</h3>
...
<p>查看详细图释:</p>
                                ...
                                <img alt="" src="images/gn045.jpg">
<img alt="" src="images/gn045-2.jpg">
<img alt="" src="images/gn045-3.jpg">
<img alt="" src="images/gn045-4.jpg">
<img alt="" src="images/gn045-5.jpg">
<img alt="" src="images/gn045-6.jpg">
<img alt="" src="images/gn045-7.jpg">
<img alt="" src="images/gn045-8.jpg">
<img alt="" src="images/gn045-9.jpg">
<img alt="" src="images/gn045-10.jpg">
                            </div>
