...
.fontRed{
								...
								<div class="bd">
									<div class="sub_title_bar no_extra">
										<h3>
											...
											<a href="<%=path%>/dazhuanpan!add.action" >
	...
	function del_service(id){
		...
		if(confirm('将删除该活动的关联数据,是否确定？此操作不可以恢复！')) { 
			$.ajax({
				...
				type : 'POST',
				data : params,
				url : 'dazhuanpan!del.action', //请求的action路径
	...
	function edit_service(id){
		loadContent('dazhuanpan!edit.action?id='+id);
		}	
  	...
  	function cogInfo(id){
  		loadContent('dazhuanpan!cogInfo.action?id='+id);
  	  	}
	</script>
</html>