			...
			<div id="left">
				<div class="col_side">
					<div class="menu_box" id="menuBar">
						<dl id="menu_function" class="menu  no_extra  open">
							<dt class="menu_title">
								<i class="icon_menu function"></i><i class="icon_menu_switch"></i>我的VXIN
							</dt>
							<dd id="menu_masssend" class="menu_item ">
								<a href="<%=path %>/showAppKeys.action">公众号管理</a>
							</dd>
							...
							<!--<dd id="menu_masssend" class="menu_item ">
								<a
									href="<%=path %>/wx/wx_guanzhu.jsp">回复管理</a>
							</dd>
							  <dd id="menu_advanced" class="menu_item ">
								<a
									href="<%=path %>/wx/wx_moren.jsp">高级功能</a>
							</dd>-->
						</dl>
						<!-- <dl id="menu_manage" class="menu  closed">
							...
							<dd id="menu_masssend" class="menu_item ">
								<a
									href="<%=path %>/keywords.action">回复管理</a>
							</dd>
						...
						<dl id="menu_service" class="menu  closed">
							...
							<dd id="menu_myservice" class="menu_item ">
								<a
									href="/cgi-bin/myservice?action=index&amp;t=service/my_service&amp;token=287667257&amp;lang=zh_CN">我的服务</a>
							</dd>
						</dl>
			...
			<div class="right">
				<div class="main">
					<iframe frameborder="0" id="mainFrame" name="mainFrame"
						src="<%=path %>/showAppKeys.action"
						style="background:url('<%=path%>/img/loading.gif?=2013-12-06-5') center no-repeat;"></iframe>
				</div>
			</div>
		</div>
		<script>
